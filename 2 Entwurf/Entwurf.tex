...
{
  name=UUID,
  description={Ein Universally Unique Identifier ist ein Standard für Identifikatoren, der in der Softwareentwicklung verwendet wird}
}
...
Wir nutzen von all den Services die Firebase bietet aber nur die Registrierung und Anmeldung mit einer Email-Adresse und einem Passwort, sowie die Möglichkeit der Wiederherstellung bei vergessen des Passworts. Firebase bietet außerdem noch viele weitere Funktionalitäten, wie push notifications an, die wir vielleicht in zukunft nutzen werden um Wunschkriterien zu implementieren.
...
\item Deutsch\
\item Elektro- und Informationstechnik\
\item Energy Engineering and Management\
\item Europ\'e4ische Kultur und Ideengeschichte\
\item Financial Engineering\
\item Funktionaler und Konstruktiver Ingenieurbau-Engineering Structures\
\item Geod\'e4sie und Geoinformatik\
\item Geographie\
\item Geo\'f6kologie\
\item Geophysik\
\item Germanistik\
\item Information Systems Engineering and Management \
\item Informatik\
\item Ingenieurp\'e4dagogik\
\item Kunstgeschichte\
\item Lebensmittelchemie\
\item Management of Product Development \
\item Maschinenbau\
...
\item Meteorologie\
\item Mobilit\'e4t und Infrastruktur\
\item Mobility Systems Engineering and Management\
\item Naturwissenschaft und Technik \
\item Optics and Photonics\
\item P\'e4dagogik\
\item Philosophie/Ethik\
\item Physik\
\item Production and Operations Management\
\item Regionalwissenschaft\
\item Remote Sensing and Geoinformatics\
\item Sport\
\item Sportwissenschaft\
\item Technische Volkswirtschaftslehre \
\item Technomathematik\
\item Water Science and Engineering\
...
\begin{itemize}
\item \textit{Professor} - Ein/e Professor/in oder Dozent/in \\
\item\textit{CollegeStudent} -  Ein/e Schüler-Student/in \\
\item\textit{Apprentice} - Ein/e Auszubildende/r \\
\item\textit{Student} - Ein/e reguläre/r Student/in \\
\item\textit{Other} - Sonstiges \\
