...
\begin{center}
	\includegraphics[scale=0.57]{Szenario_Fail.png}
\end{center}
\newpage

\section{Zustandsdiagramm}	
\begin{center}
	\includegraphics[scale=0.23]{Zustandsdiagramm.png}
\end{center}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/01.jpeg} 
		\label{Fig.1}
		(\hyperlink{cifa10}{CIFA10})Anmelden/Registrieren
	\end{minipage}
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/02.jpeg}
		\label{Fig.2}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/03.jpeg} 
		\label{Fig.3}
		(\hyperlink{cifa20}{CIFA20})Angeben persönlicher Daten
	\end{minipage}
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/04.jpeg}
		\label{Fig.4}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/05.jpeg} 
		\label{Fig.5}
		(\hyperlink{cifa60}{CIFA60})Benutzerprofil anzeigen
	\end{minipage}
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/06.jpeg}
		\label{Fig.6}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.48\textwidth} 
		\centering 
		\includegraphics[width=0.9\textwidth]{GUI/07.jpeg} 
		\label{Fig.7}
